...
export const ModifierMembreScreen = ({ route, navigation }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    lieuResidence: membre.lieu_residence || '',
    nomConjoint: membre.nom_conjoint || '',
    email: '',
    telephone: '',
    dateDeces: membre.date_deces || '',
    lieuDeces: membre.lieu_deces || '',
    informationsSupplementaires: membre.informations_supplementaires || '',
  });
  ...
  const handleSubmit = async () => {
    ...
    try {
      const dataToSend = {
        ...
        lieuDeces: formData.lieuDeces || null,
      ...
      const errorMsg = err.response?.data?.error || 'Erreur lors de la modification du membre';
      setError(errorMsg);
      ...
      <View style={styles.content}>
        ...
        <View style={styles.headerCard}>
          ...
          <View style={styles.headerInfo}>
            <Text style={styles.headerTitle}>Modification du membre</Text>
            <Text style={styles.headerSubtitle}>
              N° {membre.numero_identification}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionHint}>
            Si le membre n'a pas encore de compte, un compte utilisateur sera créé automatiquement
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionHint}>
            Laissez ces champs vides si la personne est encore en vie
          </Text>
            ...
            {Platform.OS === 'web' ? (
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  style={styles.input}
                  value={formData.dateDeces}
                  onChangeText={(value) => handleChange('dateDeces', value)}
                  placeholder="AAAA-MM-JJ"
                  placeholderTextColor={COLORS.textSecondary}
                />
              </View>
          ...
          <View style={styles.formGroup}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                ...
                onChangeText={(value) => handleChange('lieuDeces', value)}
                placeholder="Ville, Pays"
                placeholderTextColor={COLORS.textSecondary}
              />
            </View>
